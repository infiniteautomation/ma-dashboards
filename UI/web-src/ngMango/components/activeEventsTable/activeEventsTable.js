...
import activeEventsTableTemplate from './activeEventsTable.html';
import './activeEventsTable.css';
...
class ActiveEventsTableController extends TableController {
    static get $inject() {
        return ['maPoint', 'maDataPointTags', '$scope', '$element', '$injector'];
    }
    ...
    constructor(maPoint, maDataPointTags, $scope, $element, $injector) {
        super({
            ...
            localStorageKey: 'activeEventsTable',
            defaultColumns,
...
export default {
    template: activeEventsTableTemplate,
