...
/**
* @ngdoc service
* @name ngMangoServices.UserEventManager
*
* @description
* Provides an <a ui-sref="dashboard.docs.ngMangoServices.EventManager">EventManager</a> factory pointing to the websocket endpoint at `'/rest/v1/websocket/users'`
