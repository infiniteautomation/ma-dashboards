...
import arrayParse from './directives/arrayParse';
import arrayFormat from './directives/arrayFormat';
...
ngMango.directive('maArrayFormat', arrayFormat);
ngMango.directive('maArrayParse', arrayParse);
