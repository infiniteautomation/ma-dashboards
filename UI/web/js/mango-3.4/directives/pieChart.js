 ...
 * @param {object=} value-labels For use with the multi state data point render map. (see [multi-state pie chart demo](/modules/ui/web/mdAdmin/#/dashboard/examples/statistics/state-pie-chart))
 *
 * @usage
