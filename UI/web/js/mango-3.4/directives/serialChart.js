 ...
 * @param {array=} points Inputs an array of points from `<ma-point-query>`. ([See Example](/modules/mangoUI/web/mdAdmin/#/dashboard/examples/point-arrays/point-array-line-chart))
