NG_DOCS={
  ...
  "pages": [
    ...
    },
    {
      ...
      "keywords": "$ctrl $parent _blank add api aquired background based center centered change colors component components coordinate custom dark dashboard dashboardsettings data default defaults defines demo desktop desktop-height details directive display displays earth examples features flex github google googlemaps height hold href html https hybrid images info-window-theme io key lat latitude level library long longitude madashboards mamap map map-type marker mixture mobile mobile-height nested newvalue normal note object on-click optionally options output output-data passed physical pointxid position px road roadmap satellite set setoutputdata sets settings styles syntax target terrain theme true type ui-sref utilities utilizes variable view views white width window zoom"
    },
    {
      "section": "api",
      "id": "ngMango.maNow",
