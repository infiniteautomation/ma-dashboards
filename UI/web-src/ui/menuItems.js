...
//    },
    ...
    },
    {
        ...
        resolve: {
            viewTemplate: function() {
                return import(/* webpackMode: "lazy", webpackChunkName: "ui.examples" */
                        './views/examples/angularMaterial.html');
            }
        },
    ...
    },
    {
        ...
        resolve: {
            viewTemplate: function() {
                return import(/* webpackMode: "lazy", webpackChunkName: "ui.examples" */
                        './views/examples/loginPageTemplate.html');
            }
        },
        url: '/login-page',
    ...
    },
    {
        ...
        resolve: {
            viewTemplate: function() {
                return import(/* webpackMode: "lazy", webpackChunkName: "ui.examples" */
                        './views/examples/adminTemplate.html');
            }
        },
        url: '/admin-template',
